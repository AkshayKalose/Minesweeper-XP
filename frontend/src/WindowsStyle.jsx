...
export default function WindowsStyle({ children, windowTitleWidth, style }) {
    return (
        <div style={{ width: windowTitleWidth + (style === 0 ? 0 : -6)}} className="window">
          <div className="title-bar" style={{'--wails-draggable': 'drag'}}>
            ...
            <div className="title-bar-text" style={{ overflow: 'hidden', textOverflow: 'ellipsis', whiteSpace: 'nowrap' }}>
              Minesweeper
            </div>
